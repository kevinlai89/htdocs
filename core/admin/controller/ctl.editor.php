    ...
    function object_rows(){
        if($_POST['data']){
            ...
            if ($_POST['data'][0]=='_ALL_'){
                $_filter = unserialize($_POST['filter']);
                $this->pagedata['_input'] = array('items'=>$obj->getList($obj->idColumn.','.$_POST['cols'] , $_filter,-1,-1),
                                                    'idcol' => $obj->idColumn,
                ...
                $this->pagedata['_input'] = array('items'=>$obj->getList($obj->idColumn.','.$_POST['cols'] , array($obj->idColumn=>$_POST['data']),-1,-1),
                                                    'idcol' => $obj->idColumn,
                                                    'keycol' => ($_POST['key']?$_POST['key']:$obj->idColumn),
                                                    'textcol' => $obj->textColumn,
                                                    'name'=>$_POST['iptname'],
