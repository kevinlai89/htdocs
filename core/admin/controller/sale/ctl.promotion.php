...
class ctl_promotion extends objectPage{
    ...
    function addPromotion($pmtId=null,$pmtaId=null) {
        ...
        $_SESSION['SWP_PROMOTION']['activityInfo']['pmta_time_begin'] = ($_SESSION['SWP_PROMOTION']['activityInfo']['pmta_time_begin']);
        $_SESSION['SWP_PROMOTION']['activityInfo']['pmta_time_end'] = ($_SESSION['SWP_PROMOTION']['activityInfo']['pmta_time_end']);
        ...
        if ($pmtId) {
            ...
            $_SESSION['SWP_PROMOTION']['writePromotionRule'] = array(
                                                                    ...
                                                                    'pmt_time_begin' => ($aData['pmt_time_begin']),
                                                                    'pmt_time_end' => ($aData['pmt_time_end']),
