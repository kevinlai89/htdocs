...
class ctl_dashboard extends adminPage{
    ...
    function getinfo(){
            ...
            $this->pagedata['templete']='欢迎登录易开店商店系统';
            $this->pagedata['version']=$version['rev'];
            ...
            $this->pagedata['addurl'] = 'http://top.shopex.cn/promotion/yikaidian.php?id='.$this->_encDesc($strDesc);
