...
class ctl_member extends objectPage {
    ...
    var $finder_default_cols = 'uname,member_lv_id,member_refer,name,sex,email,regtime,point,mobile,arearefer_id,remark,remark_type,area,trust_name,member_refer';
