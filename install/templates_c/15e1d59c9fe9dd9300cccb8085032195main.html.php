...
</script> <body> <div class="main" id='main'> <h1 class="png title"></h1> <div class="content"> <div class="content-inner"> <?php $_tpl_tpl_vars = $this->_vars; echo $this->_fetch_compile_include($this->_vars['PAGE'], array()); $this->_vars = $_tpl_tpl_vars; unset($_tpl_tpl_vars); ?> </div> </div> </div><br/> <div id="footer" style="clear:both"><a href="http://www.shopex.cn/">ShopEx - The future of shopping. </a><br /><b>版本：<?php echo $this->_vars['version']['app']; ?>.<?php echo $this->_vars['version']['rev']; ?></b></div> </body> </html> 