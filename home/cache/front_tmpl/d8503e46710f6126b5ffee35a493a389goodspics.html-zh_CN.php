<?php if(!function_exists('tpl_modifier_storager')){ require(CORE_DIR.'/include_v5/smartyplugins/modifier.storager.php'); }  $this->_vars["_gimages"]="gimages";  $this->_vars["_small"]="small";  $this->_vars["_big"]="big";  $this->_vars["_thumbnail"]="thumbnail"; ?> <div class="goods-detail-pic" bigpicsrc="<?php echo tpl_modifier_storager(((isset($this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_big']]) && ''!==$this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_big']])?$this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_big']]:$this->system->getConf('site.default_big_pic'))); ?>"> <a href="<?php echo $this->_env_vars['base_url'],"product-{$this->_vars['goods']['goods_id']}-def",(((is_numeric(def) && 'index'==viewpic) || !viewpic)?'':'-'.viewpic),'.html';?>" target="_blank" style='color:#fff;font-size:263px;<?php if( $this->system->getConf('site.small_pic_width') !=0 && $this->system->getConf('site.small_pic_height') !=0 ){ ?> width:<?php echo $this->system->getConf('site.small_pic_width'); ?>px;height:<?php echo $this->system->getConf('site.small_pic_height'); ?>px;font-size:<?php echo (($this->system->getConf('site.small_pic_height'))*0.875);?>px;<?php } ?>;font-family:Arial;display:table-cell; vertical-align:middle;'> <img src="<?php echo tpl_modifier_storager(((isset($this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_small']]) && ''!==$this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_small']])?$this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_small']]:$this->system->getConf('site.default_small_pic'))); ?>" alt="<?php echo $this->_vars['goods']['name']; ?>" style='<?php if( $this->system->getConf('site.small_pic_width') !=0 && $this->system->getConf('site.small_pic_height') !=0 ){ ?> width:<?php echo $this->system->getConf('site.small_pic_width'); ?>px;height:<?php echo $this->system->getConf('site.small_pic_height'); ?>px;<?php } ?>'/> </a> <?php if( $this->system->getConf('site.reading_glass') ){ ?> <div class='goods-pic-magnifier' style='<?php if( $this->system->getConf('site.small_pic_width') !=0 && $this->system->getConf('site.small_pic_height') !=0 ){ ?> width:<?php echo (sprintf("%.0f",($this->system->getConf('site.small_pic_width'))*(($this->system->getConf('site.reading_glass_width'))/($this->system->getConf('site.big_pic_width')))));?>px;height:<?php echo (sprintf("%.0f",($this->system->getConf('site.small_pic_height'))*(($this->system->getConf('site.reading_glass_height'))/($this->system->getConf('site.big_pic_height')))));?>px;<?php } ?>'> &nbsp; </div> <?php } ?> </div> <table class='picscroll'> <tr> <td width='5%' class='scrollarrow toleft' title='向左'>&nbsp; </td> <td width='90%'> <div class="goods-detail-pic-thumbnail pics"> <?php if( $this->_vars['images']['gimages'] ){ ?> <center> <table> <tr> <?php if( $this->_vars['imgtype'] != 'spec' ){  $this->_vars[smallImg]=$this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_small']];  $this->_vars[bigImg]=$this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_big']];  $this->_vars[thumbnailImg]=$this->_vars['images'][$this->_vars['_gimages']][$this->_vars['goods']['image_default']][$this->_vars['_thumbnail']]; ?> <td class='current' img_id='<?php echo $this->_vars['goods']['image_default']; ?>'> <div class='uparrow'></div> <a href="<?php echo $this->_env_vars['base_url'],"product-{$this->_vars['goods']['goods_id']}-{$this->_vars['goods']['image_default']}",(((is_numeric($this->_vars['goods']['image_default']) && 'index'==viewpic) || !viewpic)?'':'-'.viewpic),'.html';?>" target="_blank" imgInfo="{small:'<?php echo tpl_modifier_storager(((isset($this->_vars['smallImg']) && ''!==$this->_vars['smallImg'])?$this->_vars['smallImg']:$this->system->getConf('site.default_small_pic'))); ?>',big:'<?php echo tpl_modifier_storager(((isset($this->_vars['bigImg']) && ''!==$this->_vars['bigImg'])?$this->_vars['bigImg']:$this->system->getConf('site.default_big_pic'))); ?>'}"> <img src="<?php echo tpl_modifier_storager(((isset($this->_vars['thumbnailImg']) && ''!==$this->_vars['thumbnailImg'])?$this->_vars['thumbnailImg']:$this->system->getConf('site.default_thumbnail_pic'))); ?>" alt='<?php echo $this->_vars['goods']['name']; ?>' width='55' height='55'/> </a> </td> <?php }  $this->_env_vars['foreach'][gimgs]=array('total'=>count($this->_vars['images']['gimages']),'iteration'=>0);foreach ((array)$this->_vars['images']['gimages'] as $this->_vars['thumb']){ $this->_env_vars['foreach'][gimgs]['first'] = ($this->_env_vars['foreach'][gimgs]['iteration']==0); $this->_env_vars['foreach'][gimgs]['iteration']++; $this->_env_vars['foreach'][gimgs]['last'] = ($this->_env_vars['foreach'][gimgs]['iteration']==$this->_env_vars['foreach'][gimgs]['total']);  if( $this->_vars['thumb']['gimage_id'] == $this->_vars['goods']['image_default'] && $this->_vars['imgtype'] != 'spec' ){  continue;  } ?> <td img_id='<?php echo $this->_vars['thumb']['gimage_id']; ?>'> <div class='uparrow'></div> <a href="<?php echo $this->_env_vars['base_url'],"product-{$this->_vars['goods']['goods_id']}-{$this->_vars['thumb']['gimage_id']}",(((is_numeric($this->_vars['thumb']['gimage_id']) && 'index'==viewpic) || !viewpic)?'':'-'.viewpic),'.html';?>" target="_blank" imgInfo="{small:'<?php echo tpl_modifier_storager(((isset($this->_vars['thumb']['small']) && ''!==$this->_vars['thumb']['small'])?$this->_vars['thumb']['small']:$this->system->getConf('site.default_small_pic'))); ?>',big:'<?php echo tpl_modifier_storager(((isset($this->_vars['thumb']['big']) && ''!==$this->_vars['thumb']['big'])?$this->_vars['thumb']['big']:$this->system->getConf('site.default_big_pic'))); ?>'}" > <img src="<?php echo tpl_modifier_storager(((isset($this->_vars['thumb']['thumbnail']) && ''!==$this->_vars['thumb']['thumbnail'])?$this->_vars['thumb']['thumbnail']:$this->system->getConf('site.default_thumbnail_pic'))); ?>" alt='<?php echo $this->_vars['goods']['name']; ?>' width='55' height='55'/> </a> </td> <?php } unset($this->_env_vars['foreach'][gimgs]); ?> </tr> </table> </center> <?php } ?> </div> </td> <td width='5%' class='scrollarrow toright' title='向右'>&nbsp; </td> </tr> </table> <a href="<?php echo $this->_env_vars['base_url'],"product-{$this->_vars['goods']['goods_id']}-{$this->_vars['goods']['image_default']}",(((is_numeric($this->_vars['goods']['image_default']) && 'index'==viewpic) || !viewpic)?'':'-'.viewpic),'.html';?>" target="_blank" onclick='_open(this.href);return false;'> <img src="statics/transparent.gif" alt="查看大图" style="width:101px;height:26px;background-image:url(statics/icons.gif);background-repeat:no-repeat;background-position:0 -121px;" /> </a> <p><span>分享到：</span></p> <script>
