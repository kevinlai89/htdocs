...
$$('#goods-viewer .hightline').addEvents({
 ...
 void function(){
         ...
         window.addEvent('domready',function(){
          ...
          /* var updatepicRequest=new Request.HTML({url:'<?php echo "product",(((is_numeric(product) && 'index'==goodspics)  || !goodspics)?'':'-'.goodspics),'.html';?>',
...
function changeimg(id,type){
    $(id).set('src','<?php echo "passport-'+type+'",(((is_numeric("'+type+'") && 'index'=="verifyCode")  || !"verifyCode")?'':'-'."verifyCode"),'.html';?>#'+$time());
};
