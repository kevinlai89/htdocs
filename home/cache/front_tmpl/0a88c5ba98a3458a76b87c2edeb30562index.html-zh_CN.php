...
</script> <?php }  if( $this->_vars['comment']['switch']['ask'] == 'on' ){  if( $this->_vars['comment']['power']['ask'] !='null' && $this->_vars['comment']['member_lv'] < 0 ){ ?> <div class="section pdtdetail" tab="购买咨询(<em><?php echo ((isset($this->_vars['comment']['askCount']) && ''!==$this->_vars['comment']['askCount'])?$this->_vars['comment']['askCount']:'0'); ?></em>)"> <div class=""><strong>购买咨询</strong><span><a href="<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-ask",(((is_numeric("ask") && 'index'=="commentlist") || !"commentlist")?'':'-'."commentlist"),'.html';?>">（已有<?php echo ((isset($this->_vars['comment']['askCount']) && ''!==$this->_vars['comment']['askCount'])?$this->_vars['comment']['askCount']:'0'); ?>条咨询）</a></span></div> <div class="FormWrap" style="background:#f6f6f6; margin-top:0px;"> <?php if( count($this->_vars['comment']['list']['ask']) == 0 ){ ?> <div class="boxBlue division"> <?php echo $this->_vars['comment']['null_notice']['ask']; ?> </div> <?php }else{ ?> <div class=" Comments" id="goods-comment"> <?php $this->_env_vars['foreach'][asklist]=array('total'=>count($this->_vars['comment']['list']['ask']),'iteration'=>0);foreach ((array)$this->_vars['comment']['list']['ask'] as $this->_vars['comlist']){ $this->_env_vars['foreach'][asklist]['first'] = ($this->_env_vars['foreach'][asklist]['iteration']==0); $this->_env_vars['foreach'][asklist]['iteration']++; $this->_env_vars['foreach'][asklist]['last'] = ($this->_env_vars['foreach'][asklist]['iteration']==$this->_env_vars['foreach'][asklist]['total']); ?> <div class="division boxBlue clearfix" style="margin-bottom:0px;"> <div class=" floatLeft commentMain"> <div class="floatLeft commentAsk">提问</div> <span class="author fontcolorOrange"><?php echo $this->_vars['comlist']['author']; ?><!--<?php if( $this->_vars['comlist']['levelname']!="" ){ ?> [<?php echo $this->_vars['comlist']['levelname']; ?>]<?php } ?> --></span> 说： <span class="timpstamp font10px fontcolorGray"><?php echo tpl_modifier_cdate($this->_vars['comlist']['time'],'SDATE_STIME'); ?></span> <div style="clear:both;"></div> <div class="commentText"><?php echo tpl_modifier_escape($this->_vars['comlist']['comment'],'html'); ?></div> </div> </div> <div class="commentReply"> <?php foreach ((array)$this->_vars['comlist']['items'] as $this->_vars['items']){ ?> <div class="division item " style=" margin:0px;" > <div class="floatLeft commentReply-admin">回答</div> <span class="author fontcolorOrange"><?php echo $this->_vars['items']['author']; ?><!--<?php if( $this->_vars['items']['levelname']!="" ){ ?> [<?php echo $this->_vars['items']['levelname']; ?>]<?php } ?> --></span>&nbsp;&nbsp;回复： <span class="timpstamp font10px fontcolorGray"><?php echo tpl_modifier_cdate($this->_vars['items']['time'],'SDATE_STIME'); ?></span> <div style="clear:both;"></div> <div class="commentText"><?php echo $this->_vars['items']['comment']; ?></div> </div> <?php } ?> </div> <?php } unset($this->_env_vars['foreach'][asklist]); ?> </div> <div class="textright"><a href="<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-ask",(((is_numeric("ask") && 'index'=="commentlist") || !"commentlist")?'':'-'."commentlist"),'.html';?>">查看所有咨询&gt;&gt;</a></div> <?php } ?> </div> <div class="boxBrown division"> <a href="<?php echo $this->_env_vars['base_url'],"passport",(((is_numeric(passport) && 'index'==login) || !login)?'':'-'.login),'.html';?>"><image src="statics/btn-ask.gif" /></a> </div> </div> <?php }else{ ?> <div class="section pdtdetail" tab="购买咨询(<em><?php echo ((isset($this->_vars['comment']['askCount']) && ''!==$this->_vars['comment']['askCount'])?$this->_vars['comment']['askCount']:'0'); ?></em>)"> <div class="commentTabLeft floatLeft"><strong>购买咨询</strong><span><a href="<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-ask",(((is_numeric("ask") && 'index'=="commentlist") || !"commentlist")?'':'-'."commentlist"),'.html';?>">（已有<?php echo ((isset($this->_vars['comment']['askCount']) && ''!==$this->_vars['comment']['askCount'])?$this->_vars['comment']['askCount']:'0'); ?>条咨询）</a></span></div> <div class="floatLeft commentTabRight"></div> <div style="clear:both;"></div> <div class="FormWrap" style="background:#f6f6f6; margin-top:0px;"> <?php if( count($this->_vars['comment']['list']['ask']) == 0 ){ ?> <div class="boxBlue division"> <?php echo $this->_vars['comment']['null_notice']['ask']; ?> </div> <?php }else{ ?> <div class=" Comments" id="goods-comment"> <?php $this->_env_vars['foreach'][asklist]=array('total'=>count($this->_vars['comment']['list']['ask']),'iteration'=>0);foreach ((array)$this->_vars['comment']['list']['ask'] as $this->_vars['comlist']){ $this->_env_vars['foreach'][asklist]['first'] = ($this->_env_vars['foreach'][asklist]['iteration']==0); $this->_env_vars['foreach'][asklist]['iteration']++; $this->_env_vars['foreach'][asklist]['last'] = ($this->_env_vars['foreach'][asklist]['iteration']==$this->_env_vars['foreach'][asklist]['total']); ?> <div class="division boxBlue clearfix" style="margin-bottom:0px;"> <div class=" floatLeft commentMain"> <div class="floatLeft commentAsk">提问</div> <span class="author fontcolorOrange"><?php echo $this->_vars['comlist']['author']; ?><!--<?php if( $this->_vars['comlist']['levelname']!="" ){ ?> [<?php echo $this->_vars['comlist']['levelname']; ?>]<?php } ?> --></span> 说： <span class="timpstamp font10px fontcolorGray"><?php echo tpl_modifier_cdate($this->_vars['comlist']['time'],'SDATE_STIME'); ?></span> <div style="clear:both;"></div> <div class="commentText"><?php echo tpl_modifier_escape($this->_vars['comlist']['comment'],'html'); ?></div> </div> <div class="floatRight"><a class="floatRight lnk " href='<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['comlist']['comment_id']}-ask",(((is_numeric("ask") && 'index'=="reply") || !"reply")?'':'-'."reply"),'.html';?>'>回复此评论</a></div> </div> <div class="commentReply"> <?php foreach ((array)$this->_vars['comlist']['items'] as $this->_vars['items']){ ?> <div class="division item " style=" margin:0px;" > <div class="floatLeft commentReply-admin">回答</div> <span class="author fontcolorOrange"><?php echo $this->_vars['items']['author']; ?><!--<?php if( $this->_vars['items']['levelname']!="" ){ ?> [<?php echo $this->_vars['items']['levelname']; ?>]<?php } ?> --></span>&nbsp;&nbsp;回复： <span class="timpstamp font10px fontcolorGray"><?php echo tpl_modifier_cdate($this->_vars['items']['time'],'SDATE_STIME'); ?></span> <div style="clear:both;"></div> <div class="commentText"><?php echo $this->_vars['items']['comment']; ?></div> </div> <?php } ?> </div> <?php } unset($this->_env_vars['foreach'][asklist]); ?> </div> <div class="textright"><a href="<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-ask",(((is_numeric("ask") && 'index'=="commentlist") || !"commentlist")?'':'-'."commentlist"),'.html';?>">查看所有咨询&gt;&gt;</a></div> <?php } ?> <form class="addcomment" method="post" action='<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-ask",(((is_numeric("ask") && 'index'=="toComment") || !"toComment")?'':'-'."toComment"),'.html';?>' onsubmit='checkFormReqs(event);'> <h4>发表咨询</h4> <div class='title'>标题：<?php echo tpl_input_default(array('type' => "text",'class' => "inputstyle blur",'required' => "true",'size' => 50,'name' => "title",'value' => "[咨询]".$this->_vars['goods']['name']), $this);?></div> <div class="division"> <table border="0" width="100%" cellpadding="0" cellspacing="0" class="forform"> <tr> <th><em>*</em>咨询内容：</th> <td><?php echo tpl_input_textarea(array('class' => "inputstyle",'vtype' => "required",'rows' => "5",'name' => "comment",'style' => "width:80%;"), $this);?></td> </tr> <tr> <tr> <th>联系方式：</th> <td><?php echo tpl_input_default(array('type' => "text",'class' => "inputstyle",'size' => 20,'name' => "contact"), $this);?><span class="infotips">(可以是电话、email、qq等)</span></td> </tr> <?php if( $this->_vars['askshow'] == "on" ){ ?> <th><em>*</em>验证码：</th> <td><?php echo tpl_input_default(array('type' => "text",'required' => "true",'size' => "4",'maxlength' => "4",'name' => "askverifyCode"), $this);?>&nbsp;<img src="<?php echo $this->_env_vars['base_url'],"passport-ask",(((is_numeric("ask") && 'index'=="verifyCode") || !"verifyCode")?'':'-'."verifyCode"),'.html';?>" border="1" id="askimgVerifyCode"/><a href="javascript:changeimg('askimgVerifyCode','ask')">&nbsp;看不清楚?换个图片</a></td> </tr> <?php } ?> <tr> <td></td> <td><input type="submit" value="提交咨询"></td> </tr> </table> </div> </form> </div> </div> <?php }  }  if( $this->_vars['comment']['switch']['discuss'] == 'on' ){  if( $this->_vars['comment']['power']['discuss'] !='null' && $this->_vars['comment']['member_lv'] < 0 ){ ?> <div class="section pdtdetail" tab="商品评论 (<em><?php echo ((isset($this->_vars['comment']['discussCount']) && ''!==$this->_vars['comment']['discussCount'])?$this->_vars['comment']['discussCount']:'0'); ?></em>)"> <div class=""><strong>商品评论</strong><span><a href="<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-discuss",(((is_numeric("discuss") && 'index'=="commentlist") || !"commentlist")?'':'-'."commentlist"),'.html';?>">（已有<em><?php echo ((isset($this->_vars['comment']['discussCount']) && ''!==$this->_vars['comment']['discussCount'])?$this->_vars['comment']['discussCount']:'0'); ?></em>条评论）</a></span></div> <div class="FormWrap" style="background:#f6f6f6; margin-top:0px;"> <?php if( count($this->_vars['comment']['list']['discuss']) == 0 ){ ?> <div class="boxBrown division"> <?php echo $this->_vars['comment']['null_notice']['discuss']; ?> </div> <?php }else{ ?> <div class=" Comments" id="goods-comment"> <?php $this->_env_vars['foreach'][discusslist]=array('total'=>count($this->_vars['comment']['list']['discuss']),'iteration'=>0);foreach ((array)$this->_vars['comment']['list']['discuss'] as $this->_vars['comlist']){ $this->_env_vars['foreach'][discusslist]['first'] = ($this->_env_vars['foreach'][discusslist]['iteration']==0); $this->_env_vars['foreach'][discusslist]['iteration']++; $this->_env_vars['foreach'][discusslist]['last'] = ($this->_env_vars['foreach'][discusslist]['iteration']==$this->_env_vars['foreach'][discusslist]['total']); ?> <div class="division boxBlue clearfix" style="margin-bottom:0px;"> <div class=" floatLeft commentMain"> <div class="floatLeft commentAsk">提问</div> <span class="author fontcolorOrange"><?php echo $this->_vars['comlist']['author']; ?><!--<?php if( $this->_vars['comlist']['levelname']!="" ){ ?> [<?php echo $this->_vars['comlist']['levelname']; ?>]<?php } ?> --></span>说： <span class="timpstamp font10px fontcolorGray replies prepend-1"><?php echo tpl_modifier_cdate($this->_vars['comlist']['time'],'SDATE_STIME'); ?></span> <div style="clear:both;"></div> <div class="commentText"><?php echo tpl_modifier_escape($this->_vars['comlist']['comment'],'html'); ?></div> </div> </div> <div class="commentReply"> <?php foreach ((array)$this->_vars['comlist']['items'] as $this->_vars['items']){ ?> <div class="division item " style=" margin:0px;" > <div class="floatLeft commentReply-admin">回复</div> <span class="author fontcolorOrange"><?php echo $this->_vars['items']['author']; ?><!--<?php if( $this->_vars['items']['levelname']!="" ){ ?> [<?php echo $this->_vars['items']['levelname']; ?>]<?php } ?> --></span>&nbsp;&nbsp;回复： <span class="timpstamp font10px fontcolorGray replies prepend-1"><?php echo tpl_modifier_cdate($this->_vars['items']['time'],'SDATE_STIME'); ?></span> <div style="clear:both;"></div> <div class="commentText"><?php echo $this->_vars['items']['comment']; ?></div> </div> <?php } ?> </div> <?php } unset($this->_env_vars['foreach'][discusslist]); ?> </div> <div class="textright"><a href="<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-discuss",(((is_numeric("discuss") && 'index'=="commentlist") || !"commentlist")?'':'-'."commentlist"),'.html';?>">查看所有评论&gt;&gt;</a></div> <?php } ?> </div> <div class="boxBrown division"> <a href="<?php echo $this->_env_vars['base_url'],"passport",(((is_numeric(passport) && 'index'==login) || !login)?'':'-'.login),'.html';?>"><image src="statics/btn-discuss.gif" /></a> </div> </div> <?php }else{ ?> <div class="section pdtdetail" tab="商品评论 (<em><?php echo ((isset($this->_vars['comment']['discussCount']) && ''!==$this->_vars['comment']['discussCount'])?$this->_vars['comment']['discussCount']:'0'); ?></em>)"> <div class="commentTabLeft floatLeft"><strong>商品评论</strong><span><a href="<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-discuss",(((is_numeric("discuss") && 'index'=="commentlist") || !"commentlist")?'':'-'."commentlist"),'.html';?>">（已有<em><?php echo ((isset($this->_vars['comment']['discussCount']) && ''!==$this->_vars['comment']['discussCount'])?$this->_vars['comment']['discussCount']:'0'); ?></em>条评论）</a></span></div> <div class="commentTabRight floatLeft"></div> <div style="clear:both;"></div> <div class="FormWrap" style="background:#f6f6f6; margin-top:0px;"> <?php if( count($this->_vars['comment']['list']['discuss']) == 0 ){ ?> <div class="boxBrown division"> <?php echo $this->_vars['comment']['null_notice']['discuss']; ?> </div> <?php }else{ ?> <div class=" Comments" id="goods-comment"> <?php $this->_env_vars['foreach'][discusslist]=array('total'=>count($this->_vars['comment']['list']['discuss']),'iteration'=>0);foreach ((array)$this->_vars['comment']['list']['discuss'] as $this->_vars['comlist']){ $this->_env_vars['foreach'][discusslist]['first'] = ($this->_env_vars['foreach'][discusslist]['iteration']==0); $this->_env_vars['foreach'][discusslist]['iteration']++; $this->_env_vars['foreach'][discusslist]['last'] = ($this->_env_vars['foreach'][discusslist]['iteration']==$this->_env_vars['foreach'][discusslist]['total']); ?> <div class="division boxBlue clearfix" style="margin-bottom:0px;"> <div class=" floatLeft commentMain"> <div class="floatLeft commentAsk">提问</div> <span class="author fontcolorOrange"><?php echo $this->_vars['comlist']['author']; ?><!--<?php if( $this->_vars['comlist']['levelname']!="" ){ ?> [<?php echo $this->_vars['comlist']['levelname']; ?>]<?php } ?> --></span>说： <span class="timpstamp font10px fontcolorGray replies prepend-1"><?php echo tpl_modifier_cdate($this->_vars['comlist']['time'],'SDATE_STIME'); ?></span> <div style="clear:both;"></div> <div class="commentText"><?php echo tpl_modifier_escape($this->_vars['comlist']['comment'],'html'); ?></div> </div> <div class="floatRight"><a class="floatRight lnk " href='<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['comlist']['comment_id']}-discuss",(((is_numeric("discuss") && 'index'=="reply") || !"reply")?'':'-'."reply"),'.html';?>'>回复此评论</a></div> </div> <div class="commentReply"> <?php foreach ((array)$this->_vars['comlist']['items'] as $this->_vars['items']){ ?> <div class="division item " style=" margin:0px;" > <div class="floatLeft commentReply-admin">回复</div> <span class="author fontcolorOrange"><?php echo $this->_vars['items']['author']; ?><!--<?php if( $this->_vars['items']['levelname']!="" ){ ?> [<?php echo $this->_vars['items']['levelname']; ?>]<?php } ?> --></span>&nbsp;&nbsp;回复： <span class="timpstamp font10px fontcolorGray replies prepend-1"><?php echo tpl_modifier_cdate($this->_vars['items']['time'],'SDATE_STIME'); ?></span> <div style="clear:both;"></div> <div class="commentText"><?php echo $this->_vars['items']['comment']; ?></div> </div> <?php } ?> </div> <?php } unset($this->_env_vars['foreach'][discusslist]); ?> </div> <div class="textright"><a href="<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-discuss",(((is_numeric("discuss") && 'index'=="commentlist") || !"commentlist")?'':'-'."commentlist"),'.html';?>">查看所有评论&gt;&gt;</a></div> <?php } ?> <form class="addcomment" method="post" action='<?php echo $this->_env_vars['base_url'],"comment-{$this->_vars['goods']['goods_id']}-discuss",(((is_numeric("discuss") && 'index'=="toComment") || !"toComment")?'':'-'."toComment"),'.html';?>' onsubmit='checkFormReqs(event);'> <h4>发表评论</h4> <div class='title'>标题：<?php echo tpl_input_default(array('type' => "text",'class' => "inputstyle blur",'required' => "true",'size' => 50,'name' => "title",'value' => "[评论]".$this->_vars['goods']['name']), $this);?></div> <div class="division"> <table border="0" cellpadding="0" cellspacing="0" width="100%" class="forform"> <tr> <th><em>*</em>评论内容：</th> <td><?php echo tpl_input_textarea(array('class' => "x-input inputstyle",'vtype' => "required",'rows' => "5",'name' => "comment",'style' => "width:80%;"), $this);?></td> </tr> <tr> <th>联系方式：</th> <td><?php echo tpl_input_default(array('type' => "text",'class' => "inputstyle",'size' => 20,'name' => "contact"), $this);?><span class="infotips">(可以是电话、email、qq等).</span></td> </tr> <?php if( $this->_vars['discussshow'] == "on" ){ ?> <tr> <th><em>*</em>验证码：</th> <td><?php echo tpl_input_default(array('type' => "text",'required' => "true",'size' => "4",'maxlength' => "4",'name' => "discussverifyCode"), $this);?>&nbsp;<img src="<?php echo $this->_env_vars['base_url'],"passport-discuss",(((is_numeric("discuss") && 'index'=="verifyCode") || !"verifyCode")?'':'-'."verifyCode"),'.html';?>" border="1" id="discussimgVerifyCode"/><a href="javascript:changeimg('discussimgVerifyCode','discuss')">&nbsp;看不清楚?换个图片</a> </td> </tr> <?php } ?> <tr> <td></td> <td><input type="submit" value="提交评论"></td> </tr> </table> </div> </form> </div> </div> <?php }  }  if( count($this->_vars['gift'])>0 ){ ?> <div class="section pdtdetail" tab="赠品"> <h2>赠品</h2> <div class="body" id="goods-gift"> <div class="GoodsSearchWrap"> <?php foreach ((array)$this->_vars['gift'] as $this->_vars['key'] => $this->_vars['gift']){ ?> <div class="items-list" product="<?php echo $this->_vars['gift']['gift_id']; ?>"> <div class="goodpic"> <?php echo tpl_input_checkbox(array('name' => "g[]",'value' => $this->_vars['gift']['goods_id']), $this);?> <a href="<?php echo $this->_env_vars['base_url'],"product-{$this->_vars['gift']['goods_id']}",(((is_numeric($this->_vars['gift']['goods_id']) && 'index'=="index") || !"index")?'':'-'."index"),'.html';?>" title="<?php echo $this->_vars['gift']['name']; ?>" style='<?php if( $this->system->getConf('site.thumbnail_pic_width') !=0 && $this->system->getConf('site.thumbnail_pic_width') !=0 ){ ?> width:<?php echo $this->system->getConf('site.thumbnail_pic_height'); ?>px;height:<?php echo $this->system->getConf('site.thumbnail_pic_height'); ?>px;<?php } ?> overflow:hidden;text-align:center;vertical-align: middle;margin:0px auto; line-height:<?php echo $this->system->getConf('site.small_pic_height'); ?>px;'> <img src="<?php echo substr($this->_vars['goods']['image_default'],0,strpos($this->_vars['goods']['image_default'],'|')); ?>" alt="<?php echo $this->_vars['gift']['name']; ?>"/></a></div> <div class="goodinfo"> <h6><a href="<?php echo $this->_env_vars['base_url'],"gift-{$this->_vars['gift']['gift_id']}",(((is_numeric($this->_vars['gift']['gift_id']) && 'index'=="index") || !"index")?'':'-'."index"),'.html';?>" title="<?php echo $this->_vars['gift']['name']; ?>"><?php echo $this->_vars['gift']['name']; ?></a></h6> <ul> <li class="intro"><?php echo $this->_vars['gift']['intro']; ?></li> <li><?php echo $this->_vars['gift']['describe']; ?></li> </ul> </div> <div class="clear"></div> </div> <?php } ?> </div> </div> </div> <?php }  if( count($this->_vars['coupon'])>0 ){ ?> <div class="section pdtdetail" tab="可得优惠券"> <h2>可得优惠券</h2> <div class="body" id="goods-coupon"> <ul style="padding:5px 20px;"> <?php foreach ((array)$this->_vars['coupon'] as $this->_vars['key'] => $this->_vars['coupon']){ ?> <li><?php echo $this->_vars['coupon']['cpns_name']; ?></li> <?php } ?> </ul> </div> </div> <?php } ?> </div> </div> <script>
...
$$('#goods-viewer .hightline').addEvents({
 ...
 void function(){
         ...
         window.addEvent('domready',function(){
          ...
          /* var updatepicRequest=new Request.HTML({url:'<?php echo $this->_env_vars['base_url'],"product",(((is_numeric(product) && 'index'==goodspics)  || !goodspics)?'':'-'.goodspics),'.html';?>',
...
function changeimg(id,type){
    $(id).set('src','<?php echo $this->_env_vars['base_url'],"passport-'+type+'",(((is_numeric("'+type+'") && 'index'=="verifyCode")  || !"verifyCode")?'':'-'."verifyCode"),'.html';?>#'+$time());
};
